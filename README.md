...
### Notes
  ...
  - [enqueue/amqp-ext](https://github.com/php-enqueue/amqp-ext) is a [AMQP interop](https://github.com/queue-interop/queue-interop#amqp-interop) compatible MQ lib built on top of the extension. 
